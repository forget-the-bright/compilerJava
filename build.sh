   ...
   docker rmi kskswanghao/compiler-java-app:latest
   docker tag compiler-java-app kskswanghao/compiler-java-app:latest
   docker push kskswanghao/compiler-java-app:latest